        ...
        <div className="mx-auto mb-20 flex w-full max-w-screen-lg flex-col overflow-hidden rounded-xl text-gray-900 md:flex-row md:border md:shadow-lg">
          <form className="mx-auto w-full max-w-xl border-gray-200 px-10 py-8 md:px-8">
            <div className="mb-4">
              ...
              <input
                className="w-full rounded border border-gray-300 px-3 py-2 outline-none ring-blue-900 focus:ring"
                id="email"
                type="email"
              />
            </div>
            ...
            <div className="flex items-center">
              ...
              <button
                className="rounded-xl bg-gradient-to-r from-orange-300 to-rose-700/50 px-4 py-3 text-center font-bold text-white hover:bg-gray-300"
                type="submit"
              >
                Send message
              </button>
          ...
          <div className="mt-10 mb-2  bg-gradient-to-r from-orange-300 to-rose-700/50   px-10 py-8 text-gray-100 md:mt-0 md:ml-auto">
            <div className="">
